<div class="container">	
	<h2 class="title text-center">Tarikan</h2>
	<div class="col-lg-offset-3">
		<form method="post" action="<?= base_url() ?>index.php/c_tabungan/tarikan" class="form-horizontal" role="form" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label class="col-lg-2 control-label">JUMLAH TARIKAN </label>
			<div class="col-lg-2">
			<input style="width: 300px;" type="number" required class="form-control" name="tarik" placeholder="Jumlah">
			</div>
		</div>
